...
static PyObject *ampl_wrapper(PyObject *self, PyObject *args) {
  ...
  /* Parsing arguments */
  if (!PyArg_ParseTuple(args, "ddOO", &u, &rho, &func0_obj, &func1_obj))
    return NULL;

  /* Interpret the input objects as numpy arrays */
  PyObject *func0_ =
      PyArray_FROM_OTF(func0_obj, NPY_DOUBLE, NPY_ARRAY_IN_ARRAY);
  PyObject *func1_ =
      PyArray_FROM_OTF(func1_obj, NPY_DOUBLE, NPY_ARRAY_IN_ARRAY);
  ...
  func0 = (double *)PyArray_DATA((PyArrayObject *)func0_);
  func1 = (double *)PyArray_DATA((PyArrayObject *)func1_);
...
static PyObject *ampl_ld_wrapper(PyObject *self, PyObject *args) {
  ...
  /* Parsing arguments */
  if (!PyArg_ParseTuple(args, "ddddOOi", &u, &rho, &Gamma, &Lambda, &func0_obj,
                        &func1_obj, &n_rings))
    return NULL;
...
static PyObject *ampl_ld_array_wrapper(PyObject *self, PyObject *args) {
  ...
  PyObject *func1_ =
      PyArray_FROM_OTF(func1_obj, NPY_DOUBLE, NPY_ARRAY_IN_ARRAY);
  PyObject *u_ = PyArray_FROM_OTF(u_obj, NPY_DOUBLE, NPY_ARRAY_IN_ARRAY);
  ...
  func0 = (double *)PyArray_DATA((PyArrayObject *)func0_);
  func1 = (double *)PyArray_DATA((PyArrayObject *)func1_);
  u = (double *)PyArray_DATA((PyArrayObject *)u_);
  npy_intp *dims = PyArray_DIMS((PyArrayObject *)u_);
  ...
  memcpy(PyArray_DATA((PyArrayObject *)A_obj), A, dims[0] * sizeof(double));
  /* Cleaning-up */
  Py_DECREF(func0_);
  Py_DECREF(func1_);
  Py_DECREF(u_);
